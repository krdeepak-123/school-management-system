...
// Reuses useAuth().changePassword — the
// same real API the admin/principal/
// teacher portals call. No new backend.
// =====================================

export default function DirectorChangePassword() {
