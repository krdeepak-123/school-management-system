...
export default function Leaves() {
  ...
  return (
    <div>
      <h1 style={styles.heading}>🗓️ Leave Requests</h1>
      <p style={styles.sub}>Apply for leave and track your requests.</p>

      {success && <div style={styles.successBanner}>✅ {success}</div>}
      {error && <div style={styles.errorBanner}>{error}</div>}

      <div style={styles.section}>
        <h2 style={styles.sectionTitle}>New Leave Request</h2>
