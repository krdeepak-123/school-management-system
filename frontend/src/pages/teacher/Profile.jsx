    ...
    <div>
      ...
      <div style={{ ...styles.section, display: "flex", gap: "20px", alignItems: "center", flexWrap: "wrap" }}>
        ...
        <div>
          ...
          <p style={{ margin: "4px 0 0 0", color: "#64748b" }}>
            Teacher ID: <strong>{profile.teacherId}</strong> | {profile.department || "Faculty"}
          </p>
        </div>
      </div>
      ...
      <div style={styles.section}>
        ...
        <div style={styles.infoRow}>
          ...
          <span style={styles.infoValue}>{profile.subject}</span>
        </div>
        <div style={styles.infoRow}>
        ...
        <div style={styles.infoRow}>
          ...
          <span style={styles.infoValue}>{profile.experience} years</span>
        </div>
        <div style={styles.infoRow}>
        ...
        {editing ? (
          ...
          <>
            ...
            <div style={styles.infoRow}>
              ...
              <span style={styles.infoValue}>{profile.qualification || "-"}</span>
            </div>
            <div style={styles.infoRow}>
